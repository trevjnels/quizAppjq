var STORE = [
  ...
  },
  {
    ...
    img:
      "http://static1.squarespace.com/static/53714acce4b0bb13e3c90e93/537264d3e4b04835e33db007/5baa7a3224a69467b83ec65a/1539719065906/1839223.jpg?format=1500w"
  },
  {
    question: "Where is Chad's Gap?",
    questionNumber: 3,
    answers: [
      { text: "Little Cottenwood Canyon", correct: true },
      { text: "Grand Tetons", correct: false },
      { text: "Baker Pass", correct: false },
      { text: "Mt. Hood", correct: false }
    ],
    img:
      "http://1.bp.blogspot.com/-xfwBcXYnwdA/T-I7GhJeKvI/AAAAAAAACA4/gyH2kPTuBbI/s1600/618_timdurtschi_chadsgap_brentbenson_ut.jpg"
  },
  {
    question: "What ski company does Candid own?",
    questionNumber: 4,
    answers: [
      { text: "Faction", correct: true },
      { text: "Armada", correct: false },
      { text: "Solomon", correct: false },
      { text: "Burton", correct: false }
    ],
    img:
      "http://www.boardsportsource.com/wp-content/uploads/historic/posts/article_2273/image_1.jpg"
  },
  {
